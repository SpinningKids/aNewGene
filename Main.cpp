...
unique_ptr<GLTexture> smoke1;
unique_ptr<GLTexture> pallino1;
unique_ptr<GLTexture> pallino2;
unique_ptr<GLTexture> greetscreds;
...
//    glColor4f(0.7, 0.75, 0.8, 1);
    ...
    drawParticles(*fumo1, smoke1.get());
...
*/
    ...
    drawParticles(*fumo2, smoke1.get());
    glTranslatef(0, 50, 0);
    drawParticles(*fiori1, pallino1.get());
...
void scenaElefanti2(float t) {
    ...
    glDepthMask(false);
    drawParticles(*fumo3, smoke1.get());
    glDepthMask(true);
}
